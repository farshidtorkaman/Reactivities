...
export default class ActivityStore {
    ...
    @observable activityCounts = 0
    @observable page = 0
    @observable predicate = new Map()

    @computed get totalPages() {
        return Math.ceil(this.activityCounts / LIMIT)
    }
    ...
    @action createActivity = async (activity: IActivity) => {
        ...
        try {
            ...
            toast.error("problem in submitting data")
            console.log(error);
        }
    }
    ...
    @action cancelAttendance = async () => {
        ...
        try {
            ...
            runInAction(() => {
                if (this.activity) {
                    this.activity.attendees = this.activity.attendees.filter(f => f.username !== this.rootStore.userStore.user!.username)
            ...
            toast.error('problem in canceling activity')
        }
    }
}